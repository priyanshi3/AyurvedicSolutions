...
public class DataDisplayLifeMedicineActivity extends AppCompatActivity {

    MyDatabase db;
    RecyclerView rcvUserList;
    DataAdapterLifeMedicine adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new MyDatabase(this);
        data.addAll(db.getdatalifemedicine(value));
        adapter = new DataAdapterLifeMedicine(data);
